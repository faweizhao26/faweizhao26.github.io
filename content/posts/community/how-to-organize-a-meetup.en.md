...
- KubeSphere
- Meetup
description: "Using an open-source offline meetup as an example, I share how to organize a community event."
...
For example, KubeSphere has a dedicated [event page](https://kubesphere.com.cn/live/) to host recaps.
